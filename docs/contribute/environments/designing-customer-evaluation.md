...
3. Third, spend real time understanding the downstream use case. Even if they give you data, you still need context. What are their users expecting? What’s business-critical? What failure actually hurts them?
